...
bool CommunicationFacade::setAngler(){
    ...
    while (true) {
        ...
        if(anglerEngine->isAnglerSelected()){
            ...
            std::cout << "Enter one of the following commands to continue: " << std::endl;\
            std::cout << "-q continue with current angler" << std::endl;
            std::cout << "-s switch to a different angler or create a new one" << std::endl;
            std::cout << "-k see if you can keep your bag" << std::endl;
            std::cout << "-d delete bag" << std::endl;
            ...
            if(input.find("-d") != std::string::npos){
                anglerEngine->clearBag();
                std::cout << "Successfully deleted bag" << std::endl;
                continue;
            }
...
bool CommunicationFacade::checkBag(){
    if(anglerEngine->canKeepBag()){
        ...
        std::cout << "--------------------------------------------------" << std::endl;
        std::cout << "Sadly you can't keep all the fish currently in your bag!" << std::endl;
        std::cout << "--------------------------------------------------" << std::endl;
